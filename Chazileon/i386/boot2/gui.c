...
//#define THEME_NAME_DEFAULT	"Default" //Azi: moved to boot.h as kDefaultThemeName.
static const char *theme_name = kDefaultThemeName;
...
int initGUI(void)
{
	...
	loadConfigFile(dirspec, &bootInfo->themeConfig); //Azi: theme.plist
...
//==========================================================================
// loadBootGraphics Azi: loading "boot logo"
...
//==========================================================================
// drawBootGraphics Azi: drawing graphics for the boot process (after pressing Enter to boot)
