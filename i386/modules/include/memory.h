...
#define ALLOC_VALID_ADDR(x)  ZALLOC_VALID_MEMORY(x)
#else
#define MALLOC_ADDR       0x08100000  // 256M malloc area
...
#define ALLOC_VALID_ADDR(x)  MALLOC_VALID_ADDR(x)
#endif
#define LOAD_ADDR         0x18100000  // 64M File load buffer
#define LOAD_LEN          0x04000000

#define APP_ALLOC_ADDR         0x1C100000  // 128M alloc area for all apps
#define APP_ALLOC_LEN		   0x8000000

// Location of data fed to boot2 by the prebooter
#define PREBOOT_DATA      0x24100000  
