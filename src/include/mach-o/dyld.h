...
/* NSObjectFileImage can only be used with MH_BUNDLE files */
    extern NSObjectFileImageReturnCode NSCreateObjectFileImageFromFile(const char* pathName, NSObjectFileImage *objectFileImage);
    ...
    extern bool                        NSDestroyObjectFileImage(NSObjectFileImage objectFileImage);

    extern uint32_t     NSSymbolDefinitionCountInObjectFileImage(NSObjectFileImage objectFileImage);
    extern const char*  NSSymbolDefinitionNameInObjectFileImage(NSObjectFileImage objectFileImage, uint32_t ordinal);
    extern uint32_t     NSSymbolReferenceCountInObjectFileImage(NSObjectFileImage objectFileImage);
    extern const char*  NSSymbolReferenceNameInObjectFileImage(NSObjectFileImage objectFileImage, uint32_t ordinal, bool *tentative_definition);
    extern bool         NSIsSymbolDefinedInObjectFileImage(NSObjectFileImage objectFileImage, const char* symbolName); 
    extern void*        NSGetSectionDataInObjectFileImage(NSObjectFileImage objectFileImage, const char* segmentName, const char* sectionName, size_t *size);
    extern bool         NSHasModInitObjectFileImage(NSObjectFileImage objectFileImage);
...
typedef struct __NSSymbol* NSSymbol;
    extern bool     NSIsSymbolNameDefined(const char* symbolName);                                                    
    extern bool     NSIsSymbolNameDefinedWithHint(const char* symbolName, const char* libraryNameHint);               
    extern bool     NSIsSymbolNameDefinedInImage(const struct mach_header* image, const char* symbolName);            
    extern NSSymbol NSLookupAndBindSymbol(const char* symbolName);
    extern NSSymbol NSLookupAndBindSymbolWithHint(const char* symbolName, const char* libraryNameHint);               
    extern NSSymbol NSLookupSymbolInModule(NSModule module, const char* symbolName);
    extern NSSymbol NSLookupSymbolInImage(const struct mach_header* image, const char* symbolName, uint32_t options);    
...
typedef enum {
    ...
    extern void NSLinkEditError(NSLinkEditErrors *c, int *errorNumber, const char** fileName, const char** errorString);
...
typedef struct {
    ...
    extern void NSInstallLinkEditErrorHandlers(const NSLinkEditErrorHandlers *handlers);

    extern bool                      NSAddLibrary(const char* pathName)                   ;
    extern bool                      NSAddLibraryWithSearching(const char* pathName)      ;
    extern const struct mach_header* NSAddImage(const char* image_name, uint32_t options) ;
...
#define NSADDIMAGE_OPTION_MATCH_FILENAME_BY_INSTALLNAME	0x8
    ...
    extern bool _dyld_launched_prebound(void)                                                    ;
    extern bool _dyld_all_twolevel_modules_prebound(void)                                        ;
    extern void _dyld_bind_objc_module(const void* objc_module)                                  ;
    extern bool _dyld_bind_fully_image_containing_address(const void* address)                   ;
    extern bool _dyld_image_containing_address(const void* address)                              ;
    extern void _dyld_lookup_and_bind(const char* symbol_name, void **address, NSModule* module) ;
    extern void _dyld_lookup_and_bind_with_hint(const char* symbol_name, const char* library_name_hint, void** address, NSModule* module);
    extern void _dyld_lookup_and_bind_fully(const char* symbol_name, void** address, NSModule* module);
    extern const struct mach_header*  _dyld_get_image_header_containing_address(const void* address);
