...
uint8_t GMAX3100_vals[22][4] = {
	{ 0x01,0x00,0x00,0x00 },	// "AAPL,HasPanel"
	{ 0x01,0x00,0x00,0x00 },	// "AAPL,SelfRefreshSupported"
	{ 0x01,0x00,0x00,0x00 },
	{ 0x00,0x00,0x00,0x08 },
	{ 0x64,0x00,0x00,0x00 },
	{ 0x00,0x00,0x00,0x08 },	// "AAPL01,blackscreen-preferences"
	{ 0x01,0x00,0x00,0x00 },	// "AAPL01,DataJustify"
	{ 0x20,0x00,0x00,0x00 },	// "AAPL01,Depth"
	{ 0x00,0x00,0x00,0x00 },
	{ 0x01,0x00,0x00,0x00 },
	{ 0x20,0x03,0x00,0x00 },	// "AAPL01,Height"
	{ 0x00,0x00,0x00,0x00 },
	{ 0x00,0x00,0x00,0x00 },
	{ 0x00,0x00,0x00,0x00 },	// "AAPL01,Inverter"
	{ 0x08,0x52,0x00,0x00 },	// "AAPL01,InverterCurrent"
	{ 0x00,0x00,0x00,0x00 },	// "AAPL01,LinkFormat"
	{ 0x00,0x00,0x00,0x00 },	// "AAPL01,LinkType"
	{ 0x01,0x00,0x00,0x00 },	// "AAPL01,Pipe"
	{ 0x01,0x00,0x00,0x00 },
	{ 0x3B,0x00,0x00,0x00 },	// "AAPL01,Stretch"
	{ 0x00,0x00,0x00,0x00 }
};
