...
// http://h30097.www3.hp.com/docs/dev_doc/DOCUMENTATION/HTML/DDK_R2/DOCS/HTML/MAN/MAN9/0192___S.HTM
...
//#define MK_CONFIG_ADDR(BUS, DEV, FUNC, REG) (unsigned long)(((BUS) << 16) | ((DEV) << 11) | ((FUNC) << 8) | ((REG) & 0xfc) | (0x80000000))
...
typedef struct {
	...
	uint16_t		image_length;  //same as rom_size for NVidia and ATI, 0x80 for Intel
...
#define PCI_COMMAND_SPECIAL					0x0008			/* Enable response to special cycles (1 byte) */
...
#define PCI_COMMAND_DISABLE_INTx			0x0400			/* PCIE: Disable INTx interrupts */
